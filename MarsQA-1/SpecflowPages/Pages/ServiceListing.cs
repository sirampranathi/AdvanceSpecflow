...
namespace MarsQA_1.SpecflowPages.Pages
{
    class ServiceListing
    {
        ...
        private static IWebElement Title => Driver.driver.FindElement(By.XPath("//input[@type='text' and @name='title']"));
        ...
        #region service listing method
        public static void SaveServiceListing()
        {

            ExcelLibHelper.PopulateInCollection(@"D:\Mars\AdvancedTaskTeam-master\onboarding.specflow-master\MarsQA-1\SpecflowTests\Data\ServiceListData.xlsx", "Service Data");
            Driver.TurnOnWait();
        ...
        #region Edit service listing method
        public  void EditServiceListing()
        {
            ...
            SelectElement subcatg = new SelectElement(SubCategory);
            Driver.TurnOnWait();
            subcatg.SelectByText(ExcelLibHelper.ReadData(3, "Sub Category"));
            ...
            startDate.Click();
            Driver.TurnOnWait();
            startDate.SendKeys(ExcelLibHelper.ReadData(3, "StartDate"));

            //Select end date
            endDate.Click();
            Driver.TurnOnWait();
            endDate.SendKeys(ExcelLibHelper.ReadData(3, "EndDate"));
            ...
            MondayStartTime.Click();
            Driver.TurnOnWait();
            MondayStartTime.SendKeys(ExcelLibHelper.ReadData(3, "MondayStartTime"));
            Driver.TurnOnWait();

            //Select end time for Monday
            MondayendTime.Click();
            Driver.TurnOnWait();
            MondayendTime.SendKeys(ExcelLibHelper.ReadData(3, "MondayendTime"));
            Driver.TurnOnWait();
            ...
            SkillTags.SendKeys(ExcelLibHelper.ReadData(3, "SkillExchangeTags") + "\n");
